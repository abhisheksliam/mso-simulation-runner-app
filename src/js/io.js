...
var initCurrentActionData = function(callback){
    ...
    if((taskData.items[parseInt(currentItemNumber)-1].methods[parseInt(currentMethodNumber)-1]) && (taskData.items[parseInt(currentItemNumber)-1].methods[parseInt(currentMethodNumber)-1].init)) {
		...
		if((taskData.items[currentItemNumber - 1].methods[currentMethodNumber - 1].actions[currentActionNumber -1]) && (taskData.items[currentItemNumber - 1].methods[currentMethodNumber - 1].actions[currentActionNumber -1].balooActionIndex !== undefined) && (taskData.items[currentItemNumber - 1].methods[currentMethodNumber - 1].actions[currentActionNumber -1].balooActionIndex !== '')) {
